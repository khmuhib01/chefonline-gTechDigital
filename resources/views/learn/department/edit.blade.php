        ...
        <div class="container">
            ...
            <form action="{{ route('department.update', $department->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" placeholder="Enter Course Name" name="name" value="{{ $department->name ?? old('name') }}">
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" name="status" value="1" {{ $department->status ? 'checked' : '' }}>
